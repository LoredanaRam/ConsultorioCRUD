    ...
    <div class="modal-content">
      ...
      <div class="modal-body bg-dark">
          ...
          <form class="form-group" >
              ...
              <input type="text" class="form-control bg-dark-lighter border-primary" id="inputEditName" placeholder="Name" required>
              ...
              <input type="text" class="form-control bg-dark-lighter  border-primary" id="inputEditDescription" placeholder="Description" required>
